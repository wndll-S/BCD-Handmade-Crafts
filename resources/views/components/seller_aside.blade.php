   <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 mt-16 z-40 w-64 border-r-2 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
