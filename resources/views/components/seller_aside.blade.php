   <aside id="sidebar-multi-level-sidebar" class="tago fixed top-0 left-0 mt-16 z-40 w-64 border-r-2 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 flex flex-col justify-between">
         <div>
            <ul class="space-y-2 font-medium">
               <li>
                  <a href="/seller/dashboard" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <li>
                  <a href="/seller/products" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="flex-1 ms-3 whitespace-nowrap">Your Handmade Crafts</span>
                     {{-- <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{$product_count}}</span> --}}
                  </a>
               </li>
               {{-- <li>
               ...
               <li>
                  <a href="/seller/orders" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{$orders->where('products.craftspeople_id', auth()->guard('seller')->user()->id)
                        ->count()}}</span>
                  </a>
               </li>
            </ul>
         ...
         <div class="border-t border-gray-300 md:mb-40 ">
