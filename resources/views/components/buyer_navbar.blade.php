    ...
    <div class="mx-1 px-4">
        <div class="flex justify-between ">
            ...
            <div class="flex space-x-4">
               <button id="sandwich" data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                ...
                <!-- logo -->
                <div >
                    <a href="{{$logo}}" class="flex items-center sm:mx-auto py-5 px-2 text-gray-700 hover:text-gray-900">
            ...
            <div id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="md:hidden flex items-center">
