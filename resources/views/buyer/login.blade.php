@include('partials.__header')
    ...
    <main class="md:flex lg:flex-row  items-center sm:block py-16">
        <section class="lg:w-3/5 flex items-center justify-center my-auto">
            <img src="{{asset('images/background_images/buyer_login.jpg')}}" alt="BCD-Handmade-Craft Buyer Login" class="shadow-xl h-3/5 w-3/5  rounded-3xl">
        </section>

        <section class="lg:w-2/5 flex-col px-20">
